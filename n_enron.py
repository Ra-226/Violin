# -*- coding: utf-8 -*-
"""
Created on Mon Oct  9 11:23:03 2023
...
def polt_figure(x,y1,y2,y3,y4,y5):
    ...
    plt.savefig("./pic/" + 'n_enron.pdf', bbox_inches = 'tight', dpi = 600)#.pdf 
    plt.show()
...
def plot_size_and_time(x,y,str):
    ...
    plt.grid()
    plt.legend(fontsize = 16)
    plt.savefig("./pic/" + 'n_{}_enron.pdf'.format(str), bbox_inches = 'tight', dpi = 600)

if __name__=='__main__':
    file = "./pkl/n_enron.pkl"
    ...
    for v_x in x:
        ...
        for times in range(run_times):
            ...
            Violin_acc, Violin_result, Violin_total_inject_size, Violin_total_inject_length,Violin_time = Violin.Violin_set_main(wordSet, query, wordAccess, total_size, word_size_set)
    ...
    with open("./pkl/n_enron.pkl","wb") as f:
        pickle.dump(D,f)
