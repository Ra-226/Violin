...
def get_size_and_length_after_injection_without_padding(real_size, real_length, real_size_after_injection, inject_length):
...
def BVA_main(wordSet, query, wordAccess, total_size, real_length, x, gamma, min_file_size, max_file_size):
    ...
    word_total_size, real_length = get_size_and_length_after_setup_padding(word_total_size, real_length, x, min_file_size, max_file_size)
