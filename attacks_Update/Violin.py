...
def get_size_and_length_after_injection_update(wordSet, length_at_setup, size_at_setup,
    ...
    return pd.Series(size_after_injection_and_update), pd.Series(
        length_after_injection_and_update), size_set_after_injection_update
...
def random_update_database(wordSet, percentage, inj_num, update_dataset, client_dataset,
    ...
    return pd.Series(update_length, dtype='float64'), pd.Series(update_size,
                                                                dtype='float64'), update_size_set, update_size_pop_set
