# -*- coding: utf-8 -*-
"""
Created on Tue Aug 20 21:32:01 2024
...
def polt_figure(df):
    ...
    plt.tick_params()
    plt.savefig("./pic/" + 'padding_ShileldDB.pdf', bbox_inches = 'tight', dpi = 600)#.pdf 
...
def polt_figure_size(df):
    ...
    plt.tick_params()
    plt.savefig("./pic/" + 'padding_ShileldDB_{}.pdf'.format("overhead"), bbox_inches = 'tight', dpi = 600)#.pdf 
    
    plt.show()

if __name__=='__main__':
    file = "./pkl/padding_ShileldDB.pkl"
    ...
    with open("./pkl/padding_ShileldDB.pkl","wb") as f:
        pickle.dump(df,f)
