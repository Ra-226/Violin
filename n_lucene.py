# -*- coding: utf-8 -*-
"""
Created on Fri Oct 27 15:32:42 2023
...
def polt_figure(x,y1,y2,y3,y4,y5):
    ...
    plt.savefig("./pic/" + 'n_Lucene.pdf', bbox_inches = 'tight', dpi = 600)#.pdf 
    plt.show()
...
def plot_size_and_time(x,y,str):
    ...
    plt.grid()
    plt.legend(fontsize = 16)
    plt.savefig("./pic/" + 'n_{}_Lucene.pdf'.format(str), bbox_inches = 'tight', dpi = 600)

if __name__=='__main__':
    file = "./pkl/n_lucene.pkl"
    ...
    with open("./pkl/n_lucene.pkl","wb") as f:
        pickle.dump(D,f)
