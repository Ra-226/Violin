# -*- coding: utf-8 -*-
"""
Created on Wed Oct 11 16:15:56 2023
...
def polt_figure(x,y1,y2,y3,y4,y5):
    ...
    plt.savefig("./pic/" + 'acc_Movies.pdf', bbox_inches = 'tight', dpi = 600)#.pdf 
    plt.show()

if __name__=='__main__':
    file = "./pkl/acc_Movies.pkl"
    ...
    with open("./pkl/acc_Movies.pkl","wb") as f:
        pickle.dump(D,f)
