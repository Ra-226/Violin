...
def get_size_and_length_after_injection_padding(word_set, size_after_setup_padding, 
    ...
    return pd.Series(size_after_injection_padding), pd.Series(length_after_injection_padding), total_size_after_padding / total_size_no_padding
...
def BVMA_NoSP_main(wordSet, word_set, query, total_size, 
    ...
    word_total_size, real_length, setup_Overhead = get_size_and_length_after_setup_padding(word_set, total_size, real_length, group, min_file_size, max_file_size)
    
    s = time.time()
    total_inject_size, injection_size, total_inject_length, inj, injection_length, min_inj_size, max_inj_size = Violin_inject(wordSet, word_total_size)
