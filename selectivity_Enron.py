...
def polt_figure(x,y1,y2,y3,y4,y5):
    ...
    plt.savefig("./pic/" + 'selectivity_enron.pdf', bbox_inches = 'tight', dpi = 600)#.pdf
    plt.show()

if __name__=='__main__':
    file = "./pkl/selectivity_enron.pkl"
    ...
    for v_x in x:
        ...
        for times in range(run_times):
            ...
            Violin_acc_temp, Violin_result, Violin_total_inject_size, Violin_total_inject_length,Violin_time = Violin.Violin_set_main(wordSet, query, wordAccess, total_size, word_size_set)
    ...
    with open("./pkl/selectivity_enron.pkl","wb") as f:
        pickle.dump(D,f)
